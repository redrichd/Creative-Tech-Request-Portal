...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4">
            <Card className="w-full max-w-md flex flex-col items-center text-center space-y-6 bg-black/20 border-white/10 backdrop-blur-2xl">
                <div className="space-y-2 flex flex-col items-center">
                    ...
                    <p className="text-white/60">工具開發需求系統</p>
                </div>
                ...
                <Button
                    ...
                    className="w-full h-12 text-lg bg-white/10 hover:bg-white/20 border-white/20"
                >
